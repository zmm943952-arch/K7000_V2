...
if (-not [string]::IsNullOrWhiteSpace($MarkdownPath)) {
    ...
    $markdown.Add("| Flash timeout audit | $statusHardwareConfirm | Flash kind timeout total is 2400 seconds across 4 steps; review table is tracked in ``docs/validation/flash-timeout-review.md``. | Fill actual duration, max observed duration, and suggested timeout after hardware timing data is available. |")
